/*****YTPRO*******
Author: Krishna Coder
Version: 3.9.5
URI: https://github.com/KrishnaCod3R/YTPRO
...
<br>
<button onclick="Android.oplink('https://github.com/KrishnaCod3R/YTPRO/issues')">Report Bugs
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="${isD ? "#ccc" : "#444"}" viewBox="0 0 16 16">
<path fill-rule="evenodd" d="M4.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L10.293 8 4.646 2.354a.5.5 0 0 1 0-.708"/>
</svg>
</button>
<br>
<button style="font-weight:bolder;" onclick="Android.oplink('https://github.com/sponsors/KrishnaCod3R');">Become a Sponsor
...
You can find the source code at <a href="#" style="font-family:monospace;" onclick="Android.oplink('https://github.com/KrishnaCod3R/YTPRO')" > https://github.com/KrishnaCod3R/YTPRO</a>
<br><br></p><br><br><br>
...
<z style="margin-left:6px">by Krishna Coder</z>
</div>
`;
...
- for the full list <u onclick="Android.oplink('https://github.com/KrishnaCod3R/YTPRO/releases');" >click here</u>
<br>
<br>
...
<button style="border:0;border-radius:10px;height:30px;width:150px;background:rgba(255,50,50,.7);float:right;" onclick="Android.downvid('YTPRO.zip','https://nightly.link/KrishnaCod3R/YTPro/workflows/gradle/main/YTPRO.zip','application/zip');">Download</button>
</div>
